...
def _toy_observations() -> pd.DataFrame:
    rows = [
        (42, 0.0, 0.95, 0.94, 0.90, 0.01, 0.02, 0.03, 0.00, 0.00, 0.50, 3.30, 0.10, 5.0),
        (42, 0.5, 0.92, 0.91, 0.87, 0.03, 0.05, 0.08, 0.04, 0.03, 0.65, 3.25, 0.09, 35.0),
        (42, 1.0, 0.88, 0.87, 0.82, 0.06, 0.09, 0.14, 0.10, 0.08, 0.75, 3.20, 0.08, 65.0),
        (7, 0.0, 0.96, 0.95, 0.91, 0.02, 0.03, 0.04, 0.00, 0.00, 0.50, 3.31, 0.10, 6.0),
        (7, 0.5, 0.93, 0.92, 0.88, 0.04, 0.06, 0.09, 0.05, 0.04, 0.66, 3.26, 0.09, 36.0),
        (7, 1.0, 0.89, 0.88, 0.83, 0.07, 0.10, 0.15, 0.11, 0.09, 0.76, 3.21, 0.08, 66.0),
    ]
